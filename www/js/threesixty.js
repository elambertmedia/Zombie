...
$(document).ready(function () {
	...
	*/
	function loadImage() {
        ...
        //POUR LOADER LES IMAGES AVEC _00000.jpg
        now =  (loadedImages + 1);
        var textToAppend = "00000";
        if(now < 10) { textToAppend = "0000"; } else if(now < 100) {textToAppend = "000";} else if(now < 1000) {textToAppend = "00";} else if(now < 10000)              {textToAppend = "0";}
        
            
		// Generates the image file name using the incremented "loadedImages" variable
		var imageName = "HR_HD/HR_HD"+ textToAppend + (loadedImages + 1) + ".jpg";
		/*
